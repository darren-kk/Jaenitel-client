    ...
    <div className="flex-center p-5">
      ...
      <main className="flex justify-between items-center w-4/5 p-10">
        <section className="w-fit h-48">
          <h2 className="flex justify-center items-center border-menu shadow-lg text-2xl w-60 h-12">Communication</h2>
        ...
        <section className="w-fit h-48">
          <h2 className="flex justify-center items-center border-menu shadow-lg text-2xl w-60 h-12">Contents</h2>
          <div className="flex-items-start p-4">
        ...
        <section className="w-fit h-48">
          <h2 className="flex justify-center items-center border-menu shadow-lg text-2xl w-60 h-12">Special</h2>
          <div className="flex-items-start p-4">
